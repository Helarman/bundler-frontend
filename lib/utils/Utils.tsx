...
export const saveTokenAddressToCookies = (tokenAddress: string) => {
  if (typeof window !== 'undefined') {
    document.cookie = `tokenAddress=${tokenAddress}; path=/; max-age=${30 * 24 * 60 * 60}`; 
  }
};

export const removeTokenAddressFromCookies = () => {
  if (typeof window !== 'undefined') {
    document.cookie = 'tokenAddress=; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT';
  }
};

export const loadTokenAddressFromCookies = (): string => {
  if (typeof window !== 'undefined') {
