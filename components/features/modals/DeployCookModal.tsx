...
import { executeCookCreate, WalletForCookCreate, TokenMetadata, CookCreateConfig } from '@/lib/utils/cookcreate';
                      ...
                      <div className="space-y-2">
                        ...
                        {tokenData.discord && (
                          <div className="flex items-center justify-between">
                            ...
                            <span className="text-sm text-primary">{tokenData.discord}</span>
                          </div>
                        )}
                      </div>
                    </>
